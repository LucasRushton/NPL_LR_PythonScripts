...
def Bfield_plotter(Bfield, observer_position, axis, separation):
    ...
    #ax.set_xticks()
    ax.set_title('B{} heatmap {:.2f}m below coils on Rx plane'.format(axis,separation))
    #fig.show()
    return my_dict
