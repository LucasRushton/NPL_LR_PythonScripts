...
if __name__ == '__main__':
    #dts = [dt.strftime('%Y-%m-%d T%H:%M:%d Z') for dt in datetime_range(datetime(2016, 9, 1, 7, 0), datetime(2016, 9, 1, 7, 5), timedelta(seconds=5))]
    ...
    #print(dts)
    filename_y = "P:/Coldatom/Telesto/2024/241025/Part11_QGB1W1D13_Xe1296dB_Xe131Gx40_BPD8_VSF150NoTrans_4dBPu_m10dBPr_Long/_Raw_data_scan0_0_300s3999Hz.dat"
    filename_x = "P:/Coldatom/Telesto/2024/241025/Part11_QGB1W1D13_Xe1296dB_Xe131Gx40_BPD8_VSF150NoTrans_4dBPu_m10dBPr_Long/_Time_data_scan0_0_300s3999Hz.dat"
    #print(filename_x, filename_y)
    #filename = np.concatenate((filename_x, filename_y))
    #print(filename)

    # Skip header
    data_x = np.loadtxt(filename_x, skiprows=0)
    data_y = np.loadtxt(filename_y, skiprows=0)
