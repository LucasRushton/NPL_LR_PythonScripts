...
# File path
path_directory = 'P:/Coldatom/RafalGartman/230825'
path_directory = 'P:/Coldatom/RafalGartman/230921'
...
path_file = 'SingPh_B0Pump_24mmAl_AwayComp_100turn2mmFR_VC87_FieldCompRF1_LS'
...
for i_pixel in range(0, length_file, 1):
    for i2 in range(start_file_freq, end_file_freq+1, increment_file_freq):
        if freq[i2] in avoid_freq:
            ...
            #print(i2)
            #print(freq[i2])
            fitted_parameters_X, pcov = curve_fit(dispersivelorentzian_or_lorentzian, f1[0], f1[1], p0 = [1E-4, freq[i2]-0.1, 0.1, 0, 1E-3], bounds=([1E-7, freq[i2]-0.2, 0.05, -2*np.pi, -0.01], [0.01, freq[i2]+0.05, 0.3, 2*np.pi, 0.01]))
