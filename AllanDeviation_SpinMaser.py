...
# Function to calculate dominant frequency using FFT
def allan_deviation_calculator(path):
    time_hours, freq_131_array, freq_129_array, freq_ratio_array, amplitude_131_array, amplitude_129_array, amplitude_ratio_array = np.transpose(np.loadtxt(path))
    (t131, ad131, ade, adn) = allantools.oadev(freq_131_array)#, rate=sample_rate, data_type="freq", taus=tau)  # Compute the overlapping ADEV
    (t129, ad129, ade, adn) = allantools.oadev(freq_129_array)#, rate=sample_rate, data_type="freq", taus=tau)  # Compute the overlapping ADEV
    fig = plt.figure()
    ax = fig.add_subplot(111)
    ax.plot(t131*1000, ad131, label='$^{129}$Xe')
    ax.plot(t129*1000, ad129, label='$^{131}$Xe')
    ax.set_xscale('log')
    ax.set_yscale('log')
    ax.set_xlabel(r'$\tau$ (s)')
    ax.set_ylabel(r'$\sigma_{y}(\tau)$')
    ax.legend()
    ax.grid()
    
def main():
    #allan_deviation_calculator_onechunkdata(path='P:/Coldatom/Telesto/2024/241025/Part11_QGB1W1D13_Xe1296dB_Xe131Gx40_BPD8_VSF150NoTrans_4dBPu_m10dBPr_Long', sample_rate=3999, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=300, section_length=50)
    #allan_deviation_calculator_multipleFFTtextfiles(path='P:/Coldatom/Telesto/2024/241025/Part9_QGB1W1D13_Xe1296dB_Xe131Gx50_BPD8_VSF150NoTrans_4dBPu_m10dBPr', sample_rate=3999, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=30, section_length=30, start_file=0, end_file=116)
    #allan_deviation_calculator_onechunkdata(path='P:/Coldatom/Telesto/2024/241118/Part1_QGB1W1_D13_m5dBPr_4dBPu_VSF180', sample_rate=1000, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=1800, section_length=300)
    #allan_deviation_calculator_onechunkdata(path='P:/Coldatom/Telesto/2024/241118/Part3_QGB1W1_D13_m5dBPr_4dBPu_VSF180_Long', sample_rate=1000, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=3600, section_length=720)
    #allan_deviation_calculator_combiningchunksdata(path='P:/Coldatom/Telesto/2024/241118/Part5_QGB1W1_D13_m5dBPr_4dBPu_VSF180_Overnight', sample_rate=1000, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=256000, section_length_time=1000, number_text_files=25600, save='n')
    #allan_deviation_calculator_combiningchunksdata(path='P:/Coldatom/Telesto/2024/241121/Part1_QGB1W1_D13_m5dBPr_4dBPu_VSF180_Overnight', sample_rate=1000, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=61000, section_length_time=1000, number_text_files=6100, save='n')
    allan_deviation_calculator_combiningchunksdata(path='P:/Coldatom/Telesto/2024/241122/Part1_QGB1W1_D13_m5dBPr_4dBPu_VSF180_TiltedCell_Weekend_No131', sample_rate=1000, lowcut_both=1, highcut_both=50, lowcut_xe129=22, highcut_xe129=24, lowcut_xe131=6, highcut_xe131=8, start_time=0, end_time=140000, section_length_time=1000, number_text_files=14000, save='n')

    #allan_deviation_calculator(path='P:/Coldatom/Telesto/2024/241118/Part5_QGB1W1_D13_m5dBPr_4dBPu_VSF180_Overnight/FreqAmplitude_Raw.dat')
